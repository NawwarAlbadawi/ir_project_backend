...
class InvertedIndex:
    ...
    def build(self, documents: list[dict]) -> None:
        ...
        logger.info(f'Inverted index built: {self.vocab_size} unique terms, avg_doc_len={self.avg_doc_length:.1f}')
    ...
    def save(self, path: Path) -> None:
        ...
        data = {'index': dict(self._index), 'doc_lengths': self._doc_lengths, 'doc_ids': self._doc_ids, 'N': self.N, 'avg_doc_length': self.avg_doc_length}
